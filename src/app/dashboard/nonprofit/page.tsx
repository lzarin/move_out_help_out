      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-medium text-stone-900">Available items</p>
              <p className="text-2xl font-semibold text-stone-700">{availableCount}</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-medium text-stone-900">My claims</p>
              <p className="text-2xl font-semibold text-stone-700">{claimsCount}</p>
            </div>
          </div>
          <ArrowRight className="h-5 w-5 text-stone-400" />
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-medium text-stone-900">Pickups</p>
              <p className="text-2xl font-semibold text-stone-700">{pickupsCount}</p>
            </div>
          </div>
          <ArrowRight className="h-5 w-5 text-stone-400" />
        </Link>
